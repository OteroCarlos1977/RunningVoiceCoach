...
private fun EmptyResultCard() {
    Card(
        ...
        Column(
            ...
            Text("Sin actividad reciente", color = ResultNavy, fontSize = 24.sp, fontWeight = FontWeight.Bold)
            Text("Cuando finalices una carrera vas a ver aca el resumen inmediato.", color = ResultMuted, fontSize = 14.sp)
        }
    }
}
